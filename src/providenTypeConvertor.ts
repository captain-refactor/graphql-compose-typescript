...
import {BaseQueue, ProvidenTypeSingular} from "./type-composer-creation/queue";
import {ComposerInstanceCreator} from "./type-composer-creation/composer-creator";
import {IOComposers, isString} from "./utils";
import {ComposeInputType, ComposeOutputType, SchemaComposer, TypeMapper} from "graphql-compose";
...
export class ProvidenTypeConvertor<T extends ComposeType, C extends ComposerIn<T> = ComposerIn<T>> {
    ...
    private get typeMapper(): TypeMapper {
